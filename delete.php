...
<li>
<a href="delete.php" title="delete" id="akt">l&ouml;schen</a>
</li>
<li>
...
if(isset($_POST['delete'])) {
	$id = $_POST['ID'];
	$product -> deleteEntry('ressourcen', $id);
}
...
<table>
<tr>
<td>&nbsp;&nbsp;&nbsp;<text>Eintrag l&ouml;schen:</text></td>
</tr>
<tr>
<td>&nbsp;&nbsp;&nbsp;<input type="text" name="ID" placeholder="ID"></td>
<td>&nbsp;&nbsp;&nbsp;<input type="submit" name="delete" value="l&ouml;schen" class="button-delete"></td>
<tr>
</table><br>
